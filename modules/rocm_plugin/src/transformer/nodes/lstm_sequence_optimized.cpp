...
namespace ov {
std::ostream& operator<<(std::ostream& s, const rocm_gpu::nodes::LSTMSequenceOptimized::MajorFormat& type) {
    return s << as_string(type);
}
template <>
EnumNames<rocm_gpu::nodes::LSTMSequenceOptimized::MajorFormat>&
EnumNames<rocm_gpu::nodes::LSTMSequenceOptimized::MajorFormat>::get() {
    static auto enum_names = EnumNames<rocm_gpu::nodes::LSTMSequenceOptimized::MajorFormat>(
        "rocm_gpu::nodes::LSTMSequenceOptimized::MajorFormat",
        {{"batch_major", rocm_gpu::nodes::LSTMSequenceOptimized::MajorFormat::BatchMajor},
         {"sequence_major", rocm_gpu::nodes::LSTMSequenceOptimized::MajorFormat::SequenceMajor}});
    return enum_names;
}
} // namespace ov