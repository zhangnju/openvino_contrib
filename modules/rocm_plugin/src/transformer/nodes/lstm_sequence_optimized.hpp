...
public:
    ...
    OPENVINO_OP("LSTMSequenceOptimized", "rocm_gpu", ov::op::util::RNNCellBase);
...
namespace ov {
template <>
class AttributeAdapter<rocm_gpu::nodes::LSTMSequenceOptimized::MajorFormat>
    : public EnumAttributeAdapterBase<rocm_gpu::nodes::LSTMSequenceOptimized::MajorFormat> {
public:
    AttributeAdapter(rocm_gpu::nodes::LSTMSequenceOptimized::MajorFormat& value)
        : EnumAttributeAdapterBase<rocm_gpu::nodes::LSTMSequenceOptimized::MajorFormat>(value) {}

    OPENVINO_RTTI("AttributeAdapter<rocm_gpu::nodes::LSTMSequenceOptimized::MajorFormat>");
};
