...
bool ov::rocm_gpu::pass::ReduceTransformation::run_on_model(const std::shared_ptr<ov::Model>& m) {
    ...
    reduce_transformations->set_name("ov::rocm_gpu::reduce_transformations");
