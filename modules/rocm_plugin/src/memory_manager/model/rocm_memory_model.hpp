...
/**
 * @brief MemoryModel describes a size of continous memory block on rocm device
...
public:
    ...
    void* deviceBufferPtr(rocm::DevicePointer<uint8_t*> devPtr, const BufferID& id);
    void* deviceTensorPtr(rocm::DevicePointer<uint8_t*> devPtr, const TensorID& id);
