...
public:
     ...
     */
    void set_stream(const rocm::Stream& stream) override { active_stream_ = &stream; }
    ...
    /**
     * Execute rocm graph sequence from SubGraph class
     * @param subGraphPtr Pointer to SubGraph
     * @param memoryManager Reference to MemoryManager
     * @param buffer Reference to orkbuffers::mutable_buffer
     * @param context Reference to InferenceRequestContext
    ...
    /**
     * Set rocm event record mode
     * @param mode Value of rocm::Event::RecordMode to set
     */
    //void set_rocm_event_record_mode(rocm::Event::RecordMode mode) override { rocm_event_record_mode_ = mode; }
...
private:
    ...
    const rocm::Stream* active_stream_ = nullptr;
    ...
    size_t infer_count_{};
    //rocm::Event::RecordMode rocm_event_record_mode_{rocm::Event::RecordMode::Default};
};
