...
Comparison::Comparison(const CreationContext& context,
    ...
    kernel_ = kernel::Comparison{operation_type,
                                 convertDataType<ov::rocm_gpu::kernel::Type_t>(element_type),
                                 output_size,
                                 num_blocks,
                                 threads_per_block};
}

rocmGraphCompatibility Comparison::GetrocmGraphCompatibility() const { return rocmGraphCompatibility::FULL; }
