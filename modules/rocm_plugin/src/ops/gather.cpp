...
GatherOp::GatherOp(const CreationContext& context,
    ...
    // For now rocm operators support only static shapes
    ...
    gather_kernel_ = kernel::Gather{convertDataType<ov::rocm_gpu::kernel::Type_t>(element_type),
...
rocmGraphCompatibility GatherOp::GetrocmGraphCompatibility() const { return rocmGraphCompatibility::FULL; }
