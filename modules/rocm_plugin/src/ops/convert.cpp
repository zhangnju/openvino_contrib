...
#include <array>
#include <rocm/rocm_type_traits.hpp>
...
ConvertOp::ConvertOp(const CreationContext& context,
    ...
    convert_kernel_ = kernel::Convert(convertDataType<ov::rocm_gpu::kernel::Type_t>(output_element_type),
                                      convertDataType<ov::rocm_gpu::kernel::Type_t>(input_element_type),
                                      size,
                                      num_blocks,
                                      threads_per_block);
}
...
rocmGraphCompatibility ConvertOp::GetrocmGraphCompatibility() const { return rocmGraphCompatibility::FULL; }
