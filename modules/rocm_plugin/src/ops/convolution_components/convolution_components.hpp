...
struct FusedConvolutionParams {
    ...
    ov::rocm_gpu::nodes::ActivationMode activation_;
};

/**
 * @brief Defines tensor indices for the following nodes:
 *  - `ov::rocm_gpu::nodes::FusedConvBackpropData`
 */
...
struct FusedConvolutionBackwardDataParams {
    FusedConvolutionBackwardDataParams(const ov::rocm_gpu::nodes::FusedConvBackpropData& node);
