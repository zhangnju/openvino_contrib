...
InterpolateLinearOp::InterpolateLinearOp(const CreationContext& context,
    ...
    OPENVINO_ASSERT(
        node.get_attrs().mode == ov::op::v4::Interpolate::InterpolateMode::LINEAR || node.get_attrs().mode == ov::op::v4::Interpolate::InterpolateMode::LINEAR_ONNX, "Node name: ", GetName());
...
rocmGraphCompatibility InterpolateLinearOp::GetrocmGraphCompatibility() const { return rocmGraphCompatibility::FULL; }
