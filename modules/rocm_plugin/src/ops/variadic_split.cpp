...
VariadicSplitOp::VariadicSplitOp(const CreationContext& context,
    ...
    variadic_split_kernel_ = kernel::VariadicSplit{convertDataType<ov::rocm_gpu::kernel::Type_t>(element_type),
                                                   num_all_chunks,
...
void VariadicSplitOp::InitSharedImmutableWorkbuffers(const IOperationExec::Buffers& buffers) {
    ...
    rocm::DefaultStream::stream().upload(buffers.at(kAxisOffsetSizesIWBIdx),
