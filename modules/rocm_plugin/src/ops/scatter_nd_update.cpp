...
ScatterNDUpdateOp::ScatterNDUpdateOp(const CreationContext& context,
    ...
    kernel_ = kernel::ScatterNDUpdate{convertDataType<ov::rocm_gpu::kernel::Type_t>(input_type),
...
rocmGraphCompatibility ScatterNDUpdateOp::GetrocmGraphCompatibility() const { return rocmGraphCompatibility::FULL; }
