...
RoundOp::RoundOp(const CreationContext& context,
    ...
    kernel_ =
        kernel::Round{convertDataType<ov::rocm_gpu::kernel::Type_t>(element_type), max_threads_per_block, num_elements};
}
...
rocmGraphCompatibility RoundOp::GetrocmGraphCompatibility() const { return rocmGraphCompatibility::FULL; }
