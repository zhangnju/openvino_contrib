...
template <typename T>
rocmGraphCompatibility StridedSliceOp<T>::GetrocmGraphCompatibility() const {
...
template <typename T>
void StridedSliceOp<T>::upload_data_to_workbuffer(rocm::DevicePointer<void*> buffer, const std::vector<T>& data) {
