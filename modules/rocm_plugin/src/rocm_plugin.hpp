...
private:
    ...
    friend class rocmInferRequest;

    enum class rocm_attribute { name };

    /**
     * Gets rocmThreadPool
     * @param config Configuration used for rocmThreadPool selection
     * @return rocmThreadPool
     */
    ...
    std::unordered_map<std::string, std::shared_ptr<rocmThreadPool>> device_thread_pool_;
};
