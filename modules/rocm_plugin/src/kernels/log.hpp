...
*/
/**
 * Elementwise Log operatio
 */
class Log {
public:
    Log(Type_t element_type, size_t max_threads_per_block, size_t num_elements);

    void operator()(hipStream_t stream, const void* in0, void* out) const;

private:
    //ElementwiseUnary<AllElementTypesSwitch, LogOpImpl> impl_;
