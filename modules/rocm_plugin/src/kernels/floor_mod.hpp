...
/**
 * Performs element-wise FloorMod operation with two given tensors applying numpy
 * broadcasting if needed.
 */
class FloorMod {
public:
    FloorMod(Type_t element_type, size_t max_threads_per_block, size_t out_num_elements);
...
private:
    //ElementwiseBinary<AllElementTypesSwitch, FloorModOpImpl> impl_;
