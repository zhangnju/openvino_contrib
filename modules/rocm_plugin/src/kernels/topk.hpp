...
private:
    ...
    void callKernelByElementType(hipStream_t stream,
                                 const void* in,
                                 void* out_value,
                                 void* out_index,
                                 void* workspace,
    ...
    void callKernelByIndexElementType(hipStream_t stream,
                                      const void* in,
                                      void* out_value,
                                      void* out_index,
                                      void* workspace,
    ...
    void callKernelByComputeType(hipStream_t stream,
                                 const void* in,
                                 void* out_value,
                                 void* out_index,
                                 void* workspace,
    ...
    void callKernelBySortType(hipStream_t stream,
                              const void* in,
                              void* out_value,
                              void* out_index,
                              void* workspace,
