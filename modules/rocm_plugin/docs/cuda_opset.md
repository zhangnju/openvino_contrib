# rocm GPU plugin operation set specification
...
> **NOTE**: rocm GPU plugin doesn't support operations with dynamic shape.
## Table of Contents <a name="toc"></a>

| Layers                                                                                                                                         | rocm GPU plugin   |
|------------------------------------------------------------------------------------------------------------------------------------------------|---------------|
...
* `'LSTMCell'`
    ...
    * MIOPEN v8.1 crash observed, see https://forums.developer.rocm.com/t/MIOPEN-crash-in-v8-1-x/194346
* `'GRUCell'`
...
* `'Multiply'`
    * supported `auto_broadcast` types are: `NONE` and `NUMPY`;
* `'Gather'`
    * supported range of values for indices tensor is `[0, data[axis] - 1]`, if a value is out of this range, rocm runtime will crash during one of the subsequent operations.
* `'Interpolate'`
