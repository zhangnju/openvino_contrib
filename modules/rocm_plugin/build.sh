...
#BUILD_TARGETS=${BUILD_TARGETS:-"ov_rocm_func_tests ov_rocm_unit_tests openvino_rocm_gpu_plugin benchmark_app"}
BUILD_TARGETS=${BUILD_TARGETS:-"openvino_rocm_gpu_plugin benchmark_app"}
WHEEL_VERSION=${WHEEL_VERSION:-"2024.4.0"}
...
[[ -d "${OPENVINO_CONTRIB}/modules/rocm_plugin" ]] || { echo "Path ${OPENVINO_CONTRIB}/modules/rocm_plugin does not exist"; exit 1; }
