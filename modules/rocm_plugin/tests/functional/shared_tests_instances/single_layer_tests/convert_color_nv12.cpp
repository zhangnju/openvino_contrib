...
using namespace ov::test::rocm_gpu;
using namespace ov::test::utils;

class ConvertColorNV12rocmLayerTest : public ConvertColorrocmLayerTest, public ConvertColorNV12LayerTest {};

TEST_P(ConvertColorNV12rocmLayerTest, Inference) { run(); }
...
INSTANTIATE_TEST_SUITE_P(smoke_TestsConvertColorNV12_single_plain,
                         ConvertColorNV12rocmLayerTest,
                         test_case_values_single_plain,
                         ConvertColorNV12rocmLayerTest::getTestCaseName);
