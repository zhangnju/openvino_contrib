...
class ConvertColorI420rocmLayerTest : public ConvertColorrocmLayerTest, public ConvertColorI420LayerTest {};

TEST_P(ConvertColorI420rocmLayerTest, Inference) { run(); }
...
INSTANTIATE_TEST_SUITE_P(smoke_TestsConvertColorI420_single_plain,
                         ConvertColorI420rocmLayerTest,
                         test_case_values_single_plain,
                         ConvertColorI420rocmLayerTest::getTestCaseName);
