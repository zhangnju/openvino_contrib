...
class ConversionrocmLayerTest : public ConversionLayerTest {};

TEST_P(ConversionrocmLayerTest, Inference) {
...
// List of precisions natively supported by rocm.
// rocm device supports only u8, f16 and f32 output precision
