...
INSTANTIATE_TEST_CASE_P(smoke_ConvolutionAsymPadrocm2D_Run,
...
// In:     (1, 2, 1000), (32, 2, 31)
// Out:    (1, 32, 1000)
// Operators: 'Tacotron2-decoder_iter:opid107' [FP32], 'Tacotron2-graph-transform-rocm-decoder_iter:opid53' [FP32]
...
// Out:    (1, 512, 1000)
// Operators: 'Tacotron2-encoder:opid12' [FP32], 'Tacotron2-encoder:opid17' [FP32], 'Tacotron2-encoder:opid7' [FP32], 'Tacotron2-graph-transform-rocm-encoder:opid13' [FP32], 'Tacotron2-graph-transform-rocm-encoder:opid18' [FP32], 'Tacotron2-graph-transform-rocm-encoder:opid8' [FP32], 'Tacotron2-graph-transform-rocm-postnet:opid12' [FP32], 'Tacotron2-graph-transform-rocm-postnet:opid17' [FP32], 'Tacotron2-graph-transform-rocm-postnet:opid7' [FP32], 'Tacotron2-postnet:opid12' [FP32], 'Tacotron2-postnet:opid17' [FP32], 'Tacotron2-postnet:opid7' [FP32]
INSTANTIATE_TEST_CASE_P(
...
// Out:    (1, 80, 1000)
// Operators: 'Tacotron2-graph-transform-rocm-postnet:opid22' [FP32], 'Tacotron2-postnet:opid22' [FP32]
INSTANTIATE_TEST_CASE_P(
    autogen_Convolution_Tacotron2_graph_transform_rocm_postnet_opid22,
    ConvolutionLayerThresholdTest,
    ::testing::Combine(
        ::testing::Combine(
            ::testing::Values(std::vector<size_t>({5})), // kernel
...
// Out:    (1, 512, 1000)
// Operators: 'Tacotron2-graph-transform-rocm-postnet:opid2' [FP32], 'Tacotron2-postnet:opid2' [FP32]
INSTANTIATE_TEST_CASE_P(
    autogen_Convolution_Tacotron2_graph_transform_rocm_postnet_opid2,
    ConvolutionLayerThresholdTest,
    ::testing::Combine(
        ::testing::Combine(
            ::testing::Values(std::vector<size_t>({5})), // kernel
