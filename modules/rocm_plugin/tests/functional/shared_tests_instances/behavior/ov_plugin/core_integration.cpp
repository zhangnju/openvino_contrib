...
INSTANTIATE_TEST_SUITE_P(smoke_OVBasicPropertiesTestsP,
                         ...
                         ::testing::Values(std::make_pair("openvino_rocm_gpu_plugin",
                                                          ov::test::utils::DEVICE_ROCM)));
...
TEST(OVClassBasicPropsTestP, smoke_rocmGetSetConfigNoThrow) {
    ov::Core core = createCoreWithTemplate();

    auto device_name = ov::test::utils::DEVICE_ROCM;
