...
const std::vector<ov::AnyMap> auto_batch_inproperties = {
    {ov::device::id("UNSUPPORTED_DEVICE_ID_STRING")},
    {{ov::device::priorities(std::string(ov::test::utils::DEVICE_ROCM) + "(4)")},
...
const std::vector<ov::AnyMap> default_properties = {{ov::num_streams(1)},
                                                    ...
                                                    {ov::device::id("0")},
                                                    {ov::rocm_gpu::operation_benchmark(false)},
                                                    {ov::rocm_gpu::use_hip_graph(true)}};
...
const std::vector<ov::AnyMap> hetero_properties = {
    {ov::device::priorities(ov::test::utils::DEVICE_ROCM), ov::enable_profiling(true)},
    {ov::device::priorities(ov::test::utils::DEVICE_ROCM), ov::device::id("0")},
};
