...
/*
 * TODO: To be moved to functional tests once they are enabled for rocm_gpu
 * */
...
class OperationBufferExtractorTest : public testing::Test {
    ...
    void SetUp() override {
        ...
        extractor_ = std::make_unique<ov::rocm_gpu::OperationBuffersExtractor>(exec_sequence_);
        ov::rocm_gpu::WorkbufferRequest request{{128}, {256}};
...
protected:
    ...
    std::unique_ptr<ov::rocm_gpu::OperationBuffersExtractor> extractor_;
    ov::rocm_gpu::WorkbufferIds buffer_indices_;
};
...
TEST_F(OperationBufferExtractorTest, CheckImmutableWorkbufferIndices) {
    using ov::rocm_gpu::WorkbufferRequest;
    using ::testing::ElementsAre;
...
class OperationBufferExtractorConcatOptimizedTest : public testing::Test {
    ...
    void SetUp() override {
        ...
        auto concat = std::make_shared<ov::rocm_gpu::nodes::ConcatOptimized>(ov::OutputVector{multiply, add_0}, 1);
...
TEST_F(OperationBufferExtractorConcatOptimizedTest, CheckTestIntegrity) {
    ...
    EXPECT_TRUE(ov::is_type<ov::rocm_gpu::nodes::ConcatOptimized>(exec_sequence_.at(OpIndex::ConcatOptimized)));
...
class OperationBufferExtractorConcatOptimizedV2Test : public testing::Test {
    ...
    void SetUp() override {
        ...
        auto concat = std::make_shared<ov::rocm_gpu::nodes::ConcatOptimized>(ov::OutputVector{reshape0, add_0}, 1);
