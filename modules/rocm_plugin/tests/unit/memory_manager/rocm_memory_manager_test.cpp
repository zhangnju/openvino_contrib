...
class MemoryManagerTest : public testing::Test, public ov::rocm_gpu::IOperationMeta {
public:
    ...
    void SetUp() override {
        // Allocate shared memory block for constant tensors
        {
            ...
            ov::rocm_gpu::ImmutableMemoryBlockBuilder builder;
        ...
        {
            ov::rocm_gpu::MemoryModelBuilder builder;
            const size_t size = 1;
    ...
    std::shared_ptr<ov::rocm_gpu::DeviceMemBlock> immutableTensors_;
    ov::rocm_gpu::MemoryModel::Ptr immutableMemoryModel_;
    ov::rocm_gpu::MemoryModel::Ptr mutableMemoryModel_;

public:  // ov::rocm_gpu::IOperationMeta
    std::vector<ov::rocm_gpu::TensorID> inputIds_;
    std::vector<ov::rocm_gpu::TensorID> outputIds_;
    ...
    gsl::span<const ov::rocm_gpu::TensorID> GetInputIds() const override { return inputIds_; }
    gsl::span<const ov::rocm_gpu::TensorID> GetOutputIds() const override { return outputIds_; }
};
...
TEST_F(MemoryManagerTest, InputTensorPointersAndTheirOrder) {
    ...
    auto allocation = rocm::DefaultStream::stream().malloc(immutableTensors_->memoryModel()->deviceMemoryBlockSize() +
